...
function ArcMark() {
  return (
    <svg width="330" height="170" viewBox="500 300 920 480" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="white"
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 48% 20%, rgba(255,255,255,0.11), transparent 38%), radial-gradient(circle at 80% 88%, rgba(179,179,179,0.12), transparent 42%)"
          }}
        />
        <div
          style={{
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", width: 600 }}>
            ...
            <div style={{ marginTop: 28, color: "rgba(255,255,255,0.58)", fontSize: 28, lineHeight: 1.35 }}>
              Melbourne&apos;s dedicated red light therapy and wellness club.
            </div>
          </div>
          <div
            style={{
